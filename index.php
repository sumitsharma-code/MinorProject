...
<body class="bg-gray-100">
  ...
  <div
    id="sidebar-overlay"
    class="fixed inset-0 bg-black/50 backdrop-blur-sm bg-opacity-70 z-40 hidden"></div>
  ...
  <script>
    async function loadDashboardStats() {
      try {
        const response = await fetch("/MinorProject/php/fetch_dashboard_stats.php");
        ...
        document.getElementById("quantityInHand").textContent = data.quantity_in_hand;
        document.getElementById("toBeReceived").textContent = data.to_be_received;
        document.getElementById("purchaseAmount").textContent = "₹" + data.purchase_amount;
        document.getElementById("totalSuppliers").textContent = data.suppliers;
